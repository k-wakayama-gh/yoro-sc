...
function toggleIsDone(todoId, sendingData) {
    fetch(`/todos/is-done/${todoId}`, {
        method: "PATCH",
...
function toggleIsDoneEventListeners() {
    document.querySelectorAll(".toggle-status-btn").forEach(button => {
        button.addEventListener("click", function(event) {
            ...
            toggleIsDone(todoId, sendingData);
...
function deleteTodoEventListeners() {
    document.querySelectorAll(".delete-btn").forEach(button => {
        button.addEventListener("click", function(event) {
            ...
            deleteForm.querySelector(".confirm-delete-btn").addEventListener("click", function() {
                deleteTodo(todoId);
                fetchAndDisplayTodos();
            });
